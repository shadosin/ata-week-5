...
public class VisitTest {
    ...
    public void visit_type_amazon_overrides_methods_and_exists_extends_Visit() {
        ...
        Class<?> amazonAccountVisitClass = assertDoesNotThrow( () -> ClassQuery.inContainingPackage(BASE_PACKAGE)
                ...
                .findClassOrFail(), "The AmazonAccountVisit generated Subclass must exist and the class MUST BE NAMED EXACTLY AmazonAccountVisit. Please double check your class name is correct before troubleshooting further.");
    ...
    public void visit_type_zappos_overrides_methods_and_exists_extends_Visit() {
        ...
        Class<?> zapposAccountVisitClass = assertDoesNotThrow( () -> ClassQuery.inContainingPackage(BASE_PACKAGE)
                ...
                .findClassOrFail(), "The ZapposAccountVisit generated Subclass must exist and MUST BE NAMED EXACTLY ZapposAccountVisit. Please double check your class name is correct before troubleshooting further.");
    ...
    public void visit_type_test_overrides_methods_and_exists_extends_Visit() {
        ...
        Class<?> testVisitClass = assertDoesNotThrow( () -> ClassQuery.inContainingPackage(BASE_PACKAGE)
                ...
                .findClassOrFail(), "The TestVisit generated Subclass must exist and MUST BE NAMED EXACTLY TestVisit. Please double check your class name is correct before troubleshooting further.");
